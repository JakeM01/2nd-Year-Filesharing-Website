        ...
        if (isset($this->getArray['pageID'])) { //check if a page id is contained in the URL
            switch ($this->getArray['pageID']) {
                ...
                case "manageFiles":
                 ...
                 case "viewFiles":
                    //create objects to generate view content
                    $contentModel = new AdminViewFiles($this->user,$this->db, $this->postArray ,$this->pageTitle, strtoupper($this->getArray['pageID']),$this->getArray['pageID']);
                ...
                case "deleteFiles":
                    //create objects to generate view content
                    $contentModel = new AdminDeleteFiles($this->user,$this->db, $this->postArray ,$this->pageTitle, strtoupper($this->getArray['pageID']),$this->getArray['pageID']);
                    $navigationModel = new NavigationAdmin($this->user, 'systemOffLine');
                    array_push($this->controllerObjects,$navigationModel,$contentModel);
                    $data = $this->getPageContent($contentModel,$navigationModel);  //get the page content from the models                 
                    $this->viewData = $data;  //put the content array into a class property for diagnostic purpose
                ...
                case "setPermissions":
                    //create objects to generate view content
                    $contentModel = new AdminPermissions($this->user, $this->db, $this->postArray,$this->pageTitle, strtoupper($this->getArray['pageID']), $this->getArray['pageID']);
