...
//TODO Put try catches around the includes. Make the includes a class with a load classes method. 
...
include_once 'classlib/entities/FilesTable.php';
...
include_once 'models/panelContent/AdminViewFiles.php';
include_once 'models/panelContent/AdminDeleteFiles.php';
include_once 'models/panelContent/AdminPermissions.php';
...
//Page models MEMBER
include_once 'models/panelContent/MemberHome.php';
include_once 'models/panelContent/MemberMyAccount.php';
include_once 'models/panelContent/MemberUploadFile.php';
include_once 'models/panelContent/MemberSearchFiles.php';
include_once 'models/panelContent/MemberEditFiles.php';
