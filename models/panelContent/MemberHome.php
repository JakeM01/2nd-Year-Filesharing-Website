<?php
/**
* This file contains the MemberPanelContent Class Template
* 
*/


/**
 * MemberPanelContent is an extended PanelModel Class
 * 
 * 
...
class MemberHome extends PanelModel{
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='MemberPanelContent';
    ...
    public function setPanelContent_1(){
        $this->panelContent_1='<p>You are currently logged in as Member User Type.';
    }      
    ...
    public function setPanelContent_2(){
        $this->panelContent_2='Thank you <b>'.$this->user->getUserFirstName().' '.$this->user->getUserLastName() .'</b> for logging in successfully as a Member user type to the sample Web Application Framework. Please use the links above to manage this system and other users. <br><br>Don\'t forget to logout when you are done.';
    }  
