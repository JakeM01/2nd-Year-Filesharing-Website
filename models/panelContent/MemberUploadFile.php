<?php
/**
* This file contains the UploadFile Class
* 
*/


/**
 * UploadFile is an extended PanelModel Class
 * 
 * 
...
class MemberUploadFile extends PanelModel{
    ...
    */    
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='MemberUploadFile';

        parent::__construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID);
        $filesTabel = new FilesTable($db);
        $filesTabel->uploadFile($user, $postArray);
    } 
    ...
    public function setPanelHead_1(){
            $this->panelHead_1='<h3>Upload File</h3>';
    }
    ...
    */      
    public function setPanelContent_1(){
       ...
       $this->panelContent_1 .= Form::form_upload_file($this->pageID);
    }   
